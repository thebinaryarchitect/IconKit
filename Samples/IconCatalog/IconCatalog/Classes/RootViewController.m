...
- (instancetype)init {
    ...
    if (self) {
        self.iconIDs = @[TBAIconIdentifierCrossMark, TBAIconIdentifierPlus, TBAIconIdentifierMinus, TBAIconIdentifierLeftArrow, TBAIconIdentifierRightArrow, TBAIconIdentifierUpArrow];
    }
    return self;
}
